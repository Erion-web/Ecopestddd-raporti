    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-green-pale px-4">
        <div className="text-center card p-8 max-w-sm w-full">
          ...
          <h1 className="text-2xl font-bold text-[#04442F] mb-2">
            Nënshkruar!
          </h1>
          <p className="text-gray-600">Vërtetimi u nënshkrua me sukses.</p>
          <p className="text-sm text-gray-400 mt-4">
            EcoPest DDD · +383 46 10 80 30
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50 px-4 py-8">
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center bg-[#04442F] rounded-2xl px-5 py-3 mb-3">
            <img
              src="/logo.svg"
              alt="EcoPest DDD"
          ...
          <p className="text-sm text-gray-500">
            Vërtetim Shërbimi #{c.serial_no as number}
          </p>
        </div>
        ...
        <div className="card p-5 mb-4">
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-semibold">{c.client_name as string}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Data</span>
              <span className="font-mono">{c.service_date as string}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Shërbimi</span>
              <span className="font-semibold">
                {(c.service_types as string[])?.join(", ")}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Teknik</span>
              <span>{c.technician_name as string}</span>
            </div>
          </div>
        </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          Duke nënshkruar, konfirmoni marrjen e shërbimit DDD.
          <br />
